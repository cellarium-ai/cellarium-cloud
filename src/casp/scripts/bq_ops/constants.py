...
PRECALCULATE_FIELDS_SQL_DIR = f"{SQL_TEMPLATES_DIR}/precalculate_fields"
# SQL Templates
# Prepare Extract
...
# Precalculate fields
TOTAL_MRNA_UMIS_SQL_DIR = f"{PRECALCULATE_FIELDS_SQL_DIR}/total_mrna_umis.sql.mako"
BQ_ROW_NUMBER_SQL_DIR = f"{PRECALCULATE_FIELDS_SQL_DIR}/bq_row_number.sql.mako"
