<%
    from casp.workflows.kubeflow.machine_specs import MeanVarStdMachineSpec

    accelerator = "cpu" if MeanVarStdMachineSpec.accelerator_type is None else "gpu"
    num_nodes = MeanVarStdMachineSpec.replica_count
    devices = 4 if MeanVarStdMachineSpec.accelerator_count is None else MeanVarStdMachineSpec.accelerator_count
%>
