...
def extract_task(
    ...
    """
    Wrapper task `cellarium.cas_backend.bq_scripts.extract_minibatch_to_anndata` which processes exactly
...
def main(
    ...
    This is a wrapper around `cellarium.cas_backend.bq_scripts.extract_minibatch_to_anndata`
    Features:
    1. Concurrently activate `cellarium.cas_backend.bq_scripts.extract_minibatch_to_anndata` multiple times (wrapped script)
