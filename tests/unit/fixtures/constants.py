...
TEST_MODEL_TYPE_REPRESENTATION = "representation"
TEST_MODEL_TYPE_CLASSIFICATION = "classification"
TEST_CLASSIFICATION_MODEL_NAME = "test-classification-model-name"
TEST_CLASSIFICATION_MODEL_FILE_PATH = "dummy-classifier.ckpt"
