...
from cellarium.cas_backend.bq_scripts import create_bigquery_objects, ingest_data_to_bq
...
def main(dataset: str, gcs_bucket_name: str, gcs_stage_dir: str, delete_ingest_files: bool = False):
    ...
    This is a wrapper around `cellarium.cas_backend.bq_scripts.ingest_data_to_bq`
    Features:
    1. Create BQ table if it doesn't exist yet (wrapper before)
    2. Activate `cellarium.cas_backend.bq_scripts.ingest_data_to_bq` with up to 5 attempts with delays
