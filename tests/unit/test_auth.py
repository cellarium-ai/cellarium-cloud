...
class TestAuth:
    ...
    @parameterized.expand(
        [
            # Success case
            (
                models.User(id=10, active=True, email="foo@bar.com"),
                20,
                uuid4(),
                uuid4(),
                False,
            ...
            # Inactive user
            (
                models.User(id=11, active=False, email="foo@bar.com"),
                21,
                uuid4(),
                uuid4(),
                False,
            ...
            # Inactive user key
            (
                models.User(id=12, active=True, email="foo@bar.com"),
                22,
                uuid4(),
                uuid4(),
                False,
            ...
            # Invalid user key
            (
                models.User(id=13, active=True, email="foo@bar.com"),
                23,
                uuid4(),
                uuid4(),
                True,
            ...
            # Expired token
            (
                models.User(id=14, active=True, email="foo@bar.com"),
                24,
                uuid4(),
                uuid4(),
                False,
            ...
            # User not found
            (
                models.User(id=15, active=True, email="foo@bar.com"),
                25,
                uuid4(),
                uuid4(),
                False,
    ...
    def test_authenticate_user_with_opaque_token(
        ...
        :param key_locator: Key locator to use when looking up in the database
        :param key: The unhashed value of the key to test
        :param make_bad_key: If True, use a bad key to test (generated by method)
