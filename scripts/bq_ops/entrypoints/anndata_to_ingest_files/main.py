...
from cellarium.cas_backend.bq_scripts import anndata_to_avro
...
def main(
    ...
    This is a wrapper around `cellarium.cas_backend.bq_scripts.anndata_to_avro`
    Features:
    1. Download anndata file from the specified bucket location (wrapper before logic)
    2. Activate `cellarium.cas_backend.bq_scripts.anndata_to_avro` script (wrapped script)
