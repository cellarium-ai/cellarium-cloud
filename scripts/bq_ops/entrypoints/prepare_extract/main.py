...
from cellarium.cas_backend.bq_scripts import prepare_all_cell_types, prepare_extract, prepare_measured_genes_info
...
def main(
    ...
    This is just a straight wrapper around `cellarium.cas_backend.bq_scripts.prepare_extract` with only passing
